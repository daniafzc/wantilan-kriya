...
import { COMMUNITIES } from "@/constant/constant";
import { CommunityCard } from "../shared/CommunityCard";
import { Spotlight } from "./Spotlightt";
        ...
        <div className="flex flex-wrap justify-between items-end gap-6 mb-8 md:mb-10">
          <div>
            <h2 className="font-serif text-3xl md:text-[38px] mb-2.5 leading-tight">
              Diskusi nyata di WhatsApp
            </h2>
            <p className="text-base text-ink-soft">
              Bergabung dengan komunitas pengrajin yang aktif berdiskusi setiap
              hari.
            </p>
          </div>
          <Link

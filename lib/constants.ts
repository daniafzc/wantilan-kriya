export const SITE_NAME = "Wantilan Kriya";
export const SITE_TAGLINE = "Knowledge · Bali";
export const SITE_DESCRIPTION =
  "Ruang gotong royong digital untuk pengrajin Bali";

export const NAV_ITEMS = [
  { id: "home", label: "Beranda", href: "/" },
  { id: "kategori", label: "Kategori", href: "/kategori" },
  { id: "artikel", label: "Artikel", href: "/artikel" },
  { id: "komunitas", label: "Komunitas", href: "/komunitas" },
  { id: "kalkulator", label: "Kalkulator Harga", href: "/kalkulator" },
